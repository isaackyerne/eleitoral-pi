 ...
 *
 * O Clerk assina os subtítulos com o nome do app no dashboard, que não é como
 * o painel se chama na tela — e o cabeçalho logo acima do cartão já diz
 * "Eleições da Bahia". Repetir ali seria redundante e inconsistente, então
